...
public class DragonConeAttackStatsDebugger : StatsDebugger
{
	...
	protected override void Update()
	{
		if (DebuggingOptions.Instance.showStats)
		{
			text.text = "Strength: " + dragonAttack.AttackStrength.ToString("F2") + "\n" +
						...
						"Cone Width: " + dragonAttack.currentDamageAreaWidth.ToString("F2") + "\n" +
						"Burn time: " + dragonAttack.currentBurnTime.ToString("F2");
	}
		else
		{
			if (text.text != "")
